...
@Log4j
public class DangStockMonitor {

    public static void main(String[] args) throws Exception {
        int index = 0;
        long timeout = 5000;
        String pattern = "MMdd_HH_mm_ss";
        String dataDir = "./data/" + DangStockMonitor.class.getSimpleName().toLowerCase();
        disableSSLCertCheck();
        ...
        while (true) {
            index++;
            String url =
                    "http://product.dangdang.com/pricestock/callback.php?type=stockv2&product_id=60597215&gift_ids=&gift_counts=&fourarea=true&shop_id=0&province_id=131&city_id=3&area_id=1310101&page_type=mall&t="
    ...
    private static boolean doValidateResponse(Response resp) {
        ...
        containList.add("havestock");
        containList.add("stock_status_value");
        containList.add("60597215");
