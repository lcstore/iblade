...
@Log4j
public class YhdStockMonitor {

    public static void main(String[] args) throws Exception {
        int index = 0;
        long timeout = 5000;
        String pattern = "MMdd_HH_mm_ss";
        String dataDir = "./data/" + YhdStockMonitor.class.getSimpleName().toLowerCase();
        disableSSLCertCheck();
        ...
        while (true) {
            index++;
            String url =
                    "http://gps.yhd.com/restful/detail?mcsite=1&provinceId=2&cityId=1000&countyId=32017&pmId=23428440&callback=jQuery111306460205119512854_1447331620950&_="
    ...
    private static boolean doValidateResponse(Response resp) {
        ...
        containList.add("productStock");
        containList.add("17820830");
