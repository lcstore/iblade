...
@Log4j
public class JdListMonitor {

    public static void main(String[] args) throws Exception {
        int index = 0;
        long timeout = 5000;
        String pattern = "MMdd_HH_mm_ss";
        String dataDir = "./data/" + JdListMonitor.class.getSimpleName().toLowerCase();
        disableSSLCertCheck();
        ...
        while (true) {
            index++;
            String url =
                    "http://list.jd.com/list.html?cat=1316,1386,11922";
    ...
    private static boolean doValidateResponse(Response resp) {
        ...
        String sCode = "2003759";
        String listId = "id=\"plist\"";
        return body.indexOf(listId) > 0 && body.indexOf("gl-item") > 0 && body.indexOf(sCode) > 0;
    }
