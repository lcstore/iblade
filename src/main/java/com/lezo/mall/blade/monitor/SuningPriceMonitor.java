...
@Log4j
public class SuningPriceMonitor {

    public static void main(String[] args) throws Exception {
        int index = 0;
        long timeout = 5000;
        String pattern = "MMdd_HH_mm_ss";
        String dataDir = "./data/" + SuningPriceMonitor.class.getSimpleName().toLowerCase();
        disableSSLCertCheck();
        ...
        while (true) {
            index++;
            String url =
                    "http://icps.suning.com/icps-web/getAllPriceFourPage/000000000134218795__021_0210101_1_pc_showSaleStatus.vhtm?callback=showSaleStatus";
    ...
    private static boolean doValidateResponse(Response resp) {
        ...
        containList.add("000000000134218795");
        containList.add("3588.00");
