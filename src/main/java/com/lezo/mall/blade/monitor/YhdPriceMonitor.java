...
@Log4j
public class YhdPriceMonitor {

    public static void main(String[] args) throws Exception {
        int index = 0;
        long timeout = 5000;
        String pattern = "MMdd_HH_mm_ss";
        String dataDir = "./data/" + YhdPriceMonitor.class.getSimpleName().toLowerCase();
        disableSSLCertCheck();
        ...
        while (true) {
            index++;
            String url =
                    "http://gps.yhd.com/restful/detail?mcsite=1&provinceId=1&pmId=41909728&callback=jQuery111304328004347221549_1447325832073&_="
    ...
    private static boolean doValidateResponse(Response resp) {
        ...
        containList.add("marketPrice");
        containList.add("89");
        containList.add("41909728");
