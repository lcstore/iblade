...
@Log4j
public class SuningStockMonitor {

    public static void main(String[] args) throws Exception {
        int index = 0;
        long timeout = 5000;
        String pattern = "MMdd_HH_mm_ss";
        String dataDir = "./data/" + SuningStockMonitor.class.getSimpleName().toLowerCase();
        disableSSLCertCheck();
        ...
        while (true) {
            index++;
            String url =
                    "http://www.suning.com/webapp/wcs/stores/GeneralPrice/000000000127925750_0000000000_9050_10339_1.html?callback=showSaleStatus";
    ...
    private static boolean doValidateResponse(Response resp) {
        ...
        containList.add("000000000127925781");
        containList.add("invStatus");
