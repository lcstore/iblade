...
@Log4j
public class GomePriceMonitor {

    public static void main(String[] args) throws Exception {
        int index = 0;
        long timeout = 5000;
        String pattern = "MMdd_HH_mm_ss";
        String dataDir = "./data/" + GomePriceMonitor.class.getSimpleName().toLowerCase();
        disableSSLCertCheck();
        ...
        while (true) {
            index++;
            String url =
                    "http://g.gome.com.cn/ec/homeus/browse/store.jsp?callback=jQuery17106520524829936394_1447319552709&goodsNo=1000366998&city=11011400&areaId=110114001&siteId_p=&skuType_p=ZSP&shelfCtgy3=AI01&zoneId=11010000&sid=1112530025&pid=9123392665&programId=111111111&threeD=n&_="
    ...
    private static boolean doValidateResponse(Response resp) {
        ...
        containList.add("isFreeShipping");
        containList.add("1499.00");
