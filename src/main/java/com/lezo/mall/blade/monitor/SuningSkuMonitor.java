...
@Log4j
public class SuningSkuMonitor {

    public static void main(String[] args) throws Exception {
        int index = 0;
        long timeout = 5000;
        String pattern = "MMdd_HH_mm_ss";
        String dataDir = "./data/" + SuningSkuMonitor.class.getSimpleName().toLowerCase();
        disableSSLCertCheck();
        String dateChars = DateFormatUtils.format(new Date(), pattern);
        int lastErrorCount = 0;
        while (true) {
            index++;
            String url = "http://product.suning.com/0000000000/134004252.html?t=" + System.currentTimeMillis();
    ...
    private static boolean doValidateResponse(Response resp) {
        ...
        containList.add("http://shop.suning.com/30000400/index.html");
        containList.add("Apple iPhone 6s Plus 16GB 玫瑰金色 移动联通电信4G手机");
        containList.add("000000000134004252");
