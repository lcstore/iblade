...
import com.lezo.mall.blade.require.top.worker.YixunBestSaleSkuWorker;

@Log4j
public class YixunBestSaleSkuMain {
    private static String CODE_SEPERATOR = "->";

    public static void main(String[] args) throws Exception {
        String srcPath = System.getProperty("src", "./data/yixun/top/cate/");
        String destPath = System.getProperty("dest", "./data/yixun/top/sku/");
        ...
        for (File dataFile : srcFiles) {
            ...
            for (String line : urlList) {
                ...
                YixunBestSaleSkuWorker worker = new YixunBestSaleSkuWorker(crumb, cateName,
