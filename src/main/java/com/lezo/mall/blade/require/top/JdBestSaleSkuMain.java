...
import com.lezo.mall.blade.require.top.worker.JdBestSaleSkuWorker;

@Log4j
public class JdBestSaleSkuMain {
    private static String CODE_SEPERATOR = "->";

    public static void main(String[] args) throws Exception {
        String srcPath = System.getProperty("src", "./data/jd/top/cate/");
        String destPath = System.getProperty("dest", "./data/jd/top/sku/");
