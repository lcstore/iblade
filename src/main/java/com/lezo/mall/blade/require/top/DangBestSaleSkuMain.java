...
import com.lezo.mall.blade.require.top.worker.DangBestSaleSkuWorker;

@Log4j
public class DangBestSaleSkuMain {

    public static void main(String[] args) throws Exception {
        String srcPath = System.getProperty("src", "./data/dangdang/top/cate/");
        String destPath = System.getProperty("dest", "./data/dangdang/top/sku/");
        ...
        for (File dataFile : srcFiles) {
            ...
            for (String line : urlList) {
                ...
                DangBestSaleSkuWorker worker = new DangBestSaleSkuWorker(crumb, cateName,
