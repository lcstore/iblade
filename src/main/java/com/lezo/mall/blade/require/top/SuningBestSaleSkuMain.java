...
import com.lezo.mall.blade.require.top.worker.SuningBestSaleSkuWorker;

@Log4j
public class SuningBestSaleSkuMain {
    private static String CODE_SEPERATOR = "->";

    public static void main(String[] args) throws Exception {
        String srcPath = System.getProperty("src", "./data/suning/top/cate/");
        String destPath = System.getProperty("dest", "./data/suning/top/sku/");
        ...
        for (File dataFile : srcFiles) {
            ...
            for (String line : urlList) {
                ...
                SuningBestSaleSkuWorker worker = new SuningBestSaleSkuWorker(crumb, cateName,
